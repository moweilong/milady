...
func FieldCommand() *cobra.Command {
  ...
  milady template field --tpl-dir=yourTemplateDir --fields=yourDefineFields.json

  # Print template code and all fields, do not generate code.
  milady template field --tpl-dir=yourTemplateDir --fields=yourDefineFields.json --only-print
  ...
  milady template field --tpl-dir=yourTemplateDir --fields=yourDefineFields.json --out=./yourDir`),
		SilenceErrors: true,
		SilenceUsage:  true,
