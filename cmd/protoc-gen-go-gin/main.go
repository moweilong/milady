...
import (
	...
	"github.com/moweilong/milady/cmd/protoc-gen-go-gin/internal/generate/handler"
	"github.com/moweilong/milady/cmd/protoc-gen-go-gin/internal/generate/router"
	"github.com/moweilong/milady/cmd/protoc-gen-go-gin/internal/generate/service"
...
func main() {
	var h bool
	flag.BoolVar(&h, "help", false, "show help info")
	flag.Parse()
	if h {
		println(helpInfo)
		return
